                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12 col-xl-10">
                                ...
                                <div class="card p-3">
                                    ...
                                    <!-- Card image -->
                                    <div class="overlay">
                                        <img class="card-img-top" src="img/fotos/seneca/publico_coworking_SENECA_primerslide.jpg" alt="Membresías Oficinas Privadas">
                                        <a href="#">
                                            <div class="mask rgba-white-slight"></div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Desde <span class="font-weight-bold">$9700</span> al mes</p>
                                        <!-- Read more button -->
                                        <a href="contacto.php" class="btn btn-outline-black btn-block waves-effect font-weight-bold">Contáctanos</a>
                                    </div>
                                </div>
