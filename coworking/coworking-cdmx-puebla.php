...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-8 white-text text-center text-md-left mt-3 mb-5 pl-4 wow fadeInLeft" data-wow-delay="0.3s">
                            ...
                            <!--<hr class="hr-light">-->
                            <h2 class="mb-4 tagtitle"><span class="font-weight-bold">Una casona del siglo XX donde habitan múltiples ideas.</h2>
                        </div>
                        <!--Grid column-->
            ...
            <div class="col-12 col-md-10">
                <div class="row">
                    <div class="col-12 col-md-10 offset-md-1">
                        <h2 class="titulos sans-bold mt-5 mb-4">Ubicado cerca de Reforma, Roma y del Bosque de Chapultepec.</h2>
    ...
    <?php require('require2/membresia-puebla.php'); ?>

    <?php require('require2/servicios-puebla.php'); ?>

    <?php require('require2/galeria-puebla.php'); ?>
                    ...
                    <div class="row justify-content-center my-4">
                        ...
                        <div class="col-12 col-lg-5 order-lg-first mb-5">
                            ...
                            <div class=" overlay rounded z-depth-1 mb-lg-0 mb-4">
                                <img class="img-fluid" src="../img/fotos/puebla/Publico-Comedor-Condesa-CDMX.jpg" alt="Público comedor Condesa CDMX">
                                <a>
