...
<head>
    ...
    <meta prefix="og: http://ogp.me/ns#" property="og:site_name" content="Publico Coworking Polanco" />
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-8 white-text text-center text-md-left mt-3 mb-5 pl-4 wow fadeInLeft" data-wow-delay="0.3s">
                            ...
                            <!--<hr class="hr-light">-->
                            <h2 class="mb-4 tagtitle">Sobrio e intelectual; un complejo de espacios para crear en uno de los barrios más cosmopolitas en CDMX. </h2>
                        </div>
                        <!--Grid column-->
    ...
    <?php require('require2/membresia-seneca.php'); ?>

    <?php require('require2/servicios-seneca.php'); ?>

    <?php require('require2/galeria-seneca.php'); ?>
